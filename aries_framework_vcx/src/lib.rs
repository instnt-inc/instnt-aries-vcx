...
//Importing and then making these modules available to the current module (aries_framework_vcx)
pub use aries_vcx;
...
pub mod framework {
    ...
    //importing wallet crates from the project
    ...
    //More imports from the project
    use did_peer::resolver::PeerDidResolver;
    use did_resolver_registry::ResolverRegistry;
    use log::{info, warn};
    use url::Url;

    //importing connection and invitation service from the same project
    use crate::{
