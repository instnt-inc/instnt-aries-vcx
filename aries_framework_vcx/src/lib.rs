uniffi::include_scaffolding!("aries_framework_vcx");

pub use crate::framework::add;// whatever we are going to expose to UDL step1
//pub use crate::connection_service::ConnectionServiceConfig;

/** below line will not make any impact if we added---step2 */
pub use aries_vcx;
...
pub mod framework {
    ...
    use log::{info, warn};
    use url::Url;
    // commented as we dont have connection_service and invitation_service in root
    // use crate::{
